"""
Discover Magazine Article Source

Implementation of ArticleSource for Discover Magazine.
...
BASE_URL = "https://www.discovermagazine.com"

# Discover Magazine topics
DISCOVER_TOPICS = [
    'planet-earth', 'health', 'mind', 'technology', 'space', 'the-sciences'
]


class DiscoverMagazineArticleSource(ArticleSource):
    """Article source implementation for Discover Magazine"""

    def __init__(self):
        super().__init__("Discover Magazine")
    ...
    def fetch_articles(
        ...
        """
        Fetch random articles from Discover Magazine
        ...
        self.logger.info(f"Fetching {count} articles from Discover Magazine")
    ...
    def _fetch_random_article(self) -> Optional[Dict[str, str]]:
        """
        Fetch a random article from Discover Magazine
        ...
        try:
            ...
            for link in soup.find_all('a', href=True):
                ...
                if '/article/' in href or any(topic in href for topic in DISCOVER_TOPICS):
            ...
            for article_url in article_links[:10]:
                ...
                if result:
                    ...
                    self.logger.info(f"✓ Fetched Discover article: {result['title']}")
                    return result
    ...
    def _fetch_article_content(self, url: str) -> Optional[Dict[str, str]]:
        """
        Fetch the content of a specific Discover Magazine article
